from animal import Mammal, Bird, Fish, Animal
...
if __name__ == '__main__':
    ...
    animal1 = Anim_manuf(animal_class='bird', name='ворона', age=3, color='серая', voice='кар-кар').get_info_animal()
    print(animal1.get_info())

    animal2 = Anim_manuf(animal_class='mammal', name='собака', age=10, hair='короткая шерсть', voice='гав-гав', color='серый').get_info_animal()
