...
open('HW8_Serialization/LEC/csv/new_biostats.csv', 'w', newline='', encoding='utf-8')as f_write):
    csv_read = csv.reader(f_read, dialect='excel-tab', delimiter= " ", quoting=csv.QUOTE_NONNUMERIC)
    ...
    for i, line in enumerate(csv_read):
        if i == 0:
            ...
            print(line)
            line[2] += 1  #  IndexError: list index out of range
