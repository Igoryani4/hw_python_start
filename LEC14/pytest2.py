...
def test_value_with_text():
    with pytest.raises(ValueError, match=r'The number P must be greater than one'):
        is_prime(1)
...
if __name__ == '__main__':
    ...
    """pytest --doctest-modules /Users/tochi/new_project/hw_python_start-2/LEC14/pytest2.py -v
