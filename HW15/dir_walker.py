...
import  os
from log_util import common_log
    ...
    try:
        for item in os.listdir(path_string):
            ...
            if item.rfind('.') != -1 and not item.startswith('.'):
                ...
                obj_name = item
            fs_objects.append(FSObject(name=obj_name, ext=obj_ext, parent=parent, is_dir= True if obj_ext == None else False))
